  ...
  return (
    <div
      className="flex flex-col justify-center items-center w-screen bg-zinc-50
        overflow-hidden"
    >
      <section className="flex flex-col items-center justify-center gap-3 h-dvh w-[290px]">
        <div className="text-center flex flex-col items-center justify-center">
          ...
          <p
            ...
            data-aos-delay={400}
          >
            Acesse ou registre-se com o Google.
          </p>
        </div>
        <Button
        ...
        >
          <p className="font-semibold gap-x-2 flex items-center justify-center z-10">
            {" "}
            <LogIn /> Continue com o Google
          </p>
        </Button>
      </section>
      <BackToHome />
